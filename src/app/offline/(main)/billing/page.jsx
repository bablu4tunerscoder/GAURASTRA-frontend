                ...
                <div className="md:space-y-8 space-y-4" >
                    ...
                    <div className="bg-white shadow rounded-2xl p-6 space-y-4">
                        <div className="space-y-6">
                            ...
                            <select className="w-full border border-gray-200 rounded-lg p-2 focus:ring-2 focus:ring-blue-500 focus:outline-none"
                                value={paymentMethod}
                ...
                <div className="rounded-xl overflow-hidden space-y-4">
                    <div className="bg-white p-6 rounded-2xl overflow-hidden shadow-md">
                                ...
                                cart.length > 0 ? cart.map((item, index) => (
                                    <div className="grid grid-cols-12 items-center py-4 border-b">
                                        ...
                                        <div className="col-span-2 flex items-center justify-center gap-2">
                                            <button onClick={() => decreaseQty(item.id)} className="w-7 h-7 flex items-center justify-center bg-gray-200 rounded-md">
                                                <Minus className="w-4 h-4" />
                                            </button>
                                            <span className="text-gray-700 font-medium">{item.qty}</span>
                                            <button onClick={() => increaseQty(item.id)} className="w-7 h-7 flex items-center justify-center bg-blue-100 text-blue-600 rounded-md">
                        ...
                        <div className="mt-6 flex justify-between md:flex-row flex-col gap-4">
                            ...
                            <button onClick={() => window.location.reload()} className="flex-1 bg-red-500 hover:bg-red-600 text-white py-2 rounded-lg flex items-center justify-center gap-2">
                        ...
                        <div className="relative z-10 p-6 pb-20 max-w-3xl mx-auto space-y-2">
                            ...
                            <div className="text-right space-y-1 flex justify-between">
                                ...
                                <div className="space-y-1">
                                    ...
                                    <p className="text-sm">
                                        <span className="text-gray-300">Date :</span> {invoiceData.date.invoice}
                                    </p>

                                    <p className="text-sm">
                                        <span className="text-gray-300">Invoice no :</span> {invoiceData.invoice_no}
                                    </p>
                                </div>
                            </div>
